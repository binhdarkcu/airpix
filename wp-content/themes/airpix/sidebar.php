    ...
    <div class="drop-navigation drop-navigation">
        <ul class="nav nav-sidebar">
            ...
            <?php if (current_user_can('administrator')): ?>
                <li class="administrator-section"><a href="<?php echo HOME_URL; ?>/wp-admin" class="user-icon"><span class="glyphicon glyphicon-home glyphicon-new-window" aria-hidden="true"></span>Administration</a></li>
            <?php endif; ?>
