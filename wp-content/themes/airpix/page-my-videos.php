...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <div class="top-grids">
            ...
            $query = "SELECT V.*, U.display_name as user_name FROM " . $wpdb->prefix . "videos  AS V  INNER JOIN ".$wpdb->prefix."users AS U ON V.user_id = $current_user->ID V.user_id = U.ID ORDER BY V.created_date desc";
